...
\code{my_code}{python}{This is some code.}{
# Mauris viverra massa id lorem pretium gravida sed convallis.
...
\tabs{my_table}{cols}{This is a table - Notice that the description wraps.}{
...
\fig{my_svg}{This is an svg-figure scaled by 0.7, and this is a very long description.}{resources/placeholder.svg}{0.7}

\fig{my_png}{This is a png-figure.}{resources/placeholder.png}{0.7}

\hh{Lists}
nteger sed metus malesuada, volutpat urna condimentum, aliquet metus. Phasellus interdum, elit vel sagittis luctus, arcu libero pellentesque nisi, sed consectetur quam neque a elit. Donec consectetur cursus nulla eu feugiat.
