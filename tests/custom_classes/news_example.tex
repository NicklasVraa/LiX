...
\fancyhead[LE,RO]{\textgoth{The Daily Bugle} -- {\footnotesize\textbf{Vol. III}}}
...
\begin{center}\scalebox{2}{\Huge\textgoth{The Daily Bugle}}\end{center}
...
\begin{multicols}{4}
    ...
    \begin{figure}[H]
        ...
        \begin{minipage}[H]{0.55\columnwidth}
            Name Lastname \\ {\footnotesize Contact information.}
        \end{minipage}
        \vspace*{-5mm}
    \end{figure}
