...
| [Novella](tests/custom_classes/novella.cls) ([tex](tests/custom_classes/novella_example.tex)\|[pdf](tests/custom_classes/novella_example.pdf)) is meant for short-stories with the intent to print. | ![p1](screenshots/novella/p1.png) | ![p2](screenshots/novella/p2.png) | ![p4](screenshots/novella/p3.png) |
| [News](tests/custom_classes/news.cls) ([tex](tests/custom_classes/news_example.tex)\|[pdf](tests/custom_classes/news_example.pdf)) is designed as a classic newspaper akin to the The New York Times. | ![p1](screenshots/news/p1.png) | ![p2](screenshots/news/p2.png) |
| [IEEE](tests/popular_classes/ieee.cls) ([tex](tests/popular_classes/ieee_example.tex)\|[pdf](tests/popular_classes/ieee_example.pdf)) implements the IEEE journal and transactions template, but using LiX. | ![p1](screenshots/ieee/p1.png) | ![p2](screenshots/ieee/p2.png) |
